namespace ChapinCine.Modelo
{
    ...
    public abstract class Cliente
    {
        ...
        /// <summary>
        /// Devuelve al cliente un monto que se le había cobrado.
        /// Es la operación inversa de AplicarCobro y permite restaurar el
        /// estado del cliente cuando una operación no se completa.
        /// </summary>
        public abstract void RevertirCobro(int monto);
    }
}
